          ...
          <div className="content-header">
            ...
            <p className="content-subtitle">
              ...
              {activeTab === "express-interests" &&
                "Monitor your property interest requests waiting for admin approval"}
            ...
            <div className="interests-grid">
              {expressInterests.length === 0 ? (
                <div className="empty-state">
                  ...
                  <p className="empty-subtitle">
                    You haven't expressed interest in any properties yet. Browse
                    properties and show your interest!
                  </p>
                </div>
              ) : (
                  ...
                  <div key={interest.id} className="interest-card">
                    <div className="interest-header">
                      ...
                      <div className="interest-actions">
                        <div className="mb-2">
                          {getStatusBadge(
                            interest.is_active ? "Active" : "Expired"
                          )}
                        </div>
