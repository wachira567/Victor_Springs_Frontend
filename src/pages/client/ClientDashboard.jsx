...
const ClientDashboard = () => {
  ...
  const [interestsTab, setInterestsTab] = useState("express-interests");
  ...
  const confirmedVisits = siteVisits.filter(
    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-header">
        <div className="dashboard-welcome">
          <div className="welcome-text">
            <h1>
              Welcome back, {profileData.username || user?.username || "user"}!
              🎉
            </h1>
      ...
      <div className="quick-actions">
        ...
        <div
          className="action-card"
          onClick={() => {
            setActiveTab("my-interests");
            setInterestsTab("saved");
          }}
        >
          <div className="action-header">
        ...
        <div className="main-content">
          <div className="content-header">
            <h1 className="content-title">
              ...
              {activeTab === "my-interests" && "My Interests"}
              {activeTab === "settings" && "Account Settings"}
            </h1>
            <p className="content-subtitle">
              {activeTab === "site-visits" &&
                "Track your scheduled property viewings and their approval status"}
              {activeTab === "my-interests" &&
                "Manage your property interests and saved favorites"}
              {activeTab === "settings" &&
            ...
            {activeTab === "my-interests" && (
              <div className="interests-tabs">
                <button
                  onClick={() => setInterestsTab("express-interests")}
                  className={`tab-button ${
                    interestsTab === "express-interests" ? "active" : ""
                  }`}
                >
                  Express Interests
                </button>
                <button
                  onClick={() => setInterestsTab("saved")}
                  className={`tab-button ${
                    interestsTab === "saved" ? "active" : ""
                  }`}
                >
                  Saved Properties
                </button>
          ...
          <>
                ...
                {siteVisits.length === 0 ? (
                  <div className="empty-state">
                    ...
                    <p className="empty-subtitle">
                      ...
                      properties and book a site visit!
                    </p>
                  </div>
                ) : (
                    ...
                    <div key={visit.id} className="visit-card">
                      ...
                      <div className="visit-header">
                        <div>
                          <h3 className="visit-title">
                            {visit.property_name || "Site Visit"}
                          </h3>
                          <div className="visit-meta">
                            ...
                            <div className="visit-meta-item">
                              <MapPin size={16} />
                              <span>
                                {visit.unit_type_name || "Property Unit"}
                              </span>
                            </div>
                          </div>
                        </div>
                      ...
                      {visit.admin_notes && (
                        <div className="visit-notes">
                          <p>
                            <strong>Admin Notes:</strong> {visit.admin_notes}
                          </p>
                        </div>
                      )}
                    </div>
            ...
            {activeTab === "my-interests" &&
              interestsTab === "express-interests" && (
                  ...
                  {expressInterests.length === 0 ? (
                    <div className="empty-state">
                      ...
                      <p className="empty-subtitle">
                        ...
                        Browse properties and show your interest!
                      </p>
                    </div>
                  ) : (
                    expressInterests.map((interest) => {
                      const isExpired =
                        ...
                        new Date(interest.valid_until) < new Date();
                        ...
                        >
                          ...
                          {interest.notifications &&
                            interest.notifications.length > 0 && (
                              <div className="interest-notifications">
                                <p>
            ...
            {activeTab === "my-interests" && interestsTab === "saved" && (
              <div className="saved-grid">
                {savedProperties.length === 0 ? (
                  <div className="empty-state">
                    ...
                    <p className="empty-subtitle">
                      Start exploring properties and save your favorites by
                    ...
                    <div key={property.id} className="saved-card">
                      ...
                      <div className="saved-header">
                        ...
                        <div className="saved-actions">
                          ...
                          <button
                            onClick={() =>
                              handleDeleteSavedProperty(property.id)
                            }
                            className="btn-icon btn-delete"
                      ...
                      <div className="saved-address">{property.address}</div>
                    </div>
                  ))
                )}
              </div>
